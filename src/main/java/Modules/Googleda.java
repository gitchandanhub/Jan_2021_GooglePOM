...
public class Googleda  extends AppDriver 
{
	File src;
	XSSFWorkbook wb;
	XSSFSheet sheet;
	...
	AtomicInteger count = new AtomicInteger(1);
        ...
        public void fetchdata(String urlsheet, int rownum) throws IOException, InterruptedException
    	{
    		for(int i =rownum; i<22009; i++)
    		{
    			City = Readwriteexcel.readexcel(urlsheet, 0, i, 0);
    			String url = Readwriteexcel.readexcel(urlsheet, 0, i, 1);
    			category = Readwriteexcel.readexcel(urlsheet, 0, i, 2);
